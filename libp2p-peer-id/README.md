...
**PQC migration plan:** None — no PQC key type in libp2p spec; go-libp2p roadmap has no PQC item
...
A CRQC can derive the private key from the public peer ID, then impersonate any peer.
...
- No PQC key type is defined in the libp2p-crypto spec or in any active proposal
