...
- Microsoft's [MS-BKRP] protocol spec does not define non-RSA key types. Changing the algorithm
...
- HNDL: corporate DPAPI data files are frequently backed up (they're in user profiles,
 ...
 the domain RSA-2048 key when a factoring break is available. decrypt all historical DPAPI archives
