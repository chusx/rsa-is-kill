...
stored on the substation engineering workstation. It's the input an attacker needs document.
...
- IEC TC57/WG15 has not published any guidance on non-RSA alternatives or work item for IEC 62351.
