...
kubeadm creates RSA-2048 cluster CAs with 10-year validity. a cluster bootstrapped in 2025 has certs expiring in 2035. that window overlaps pretty uncomfortably with factoring-break timelines.
...
- full non-RSA cert chain needs Go 1.26 ML-DSA support, plus updates to kube-apiserver, etcd, and kubelet. none of it is done yet
