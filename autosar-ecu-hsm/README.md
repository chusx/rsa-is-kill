...
- **AUTOSAR Crypto Stack**: `CRYPTO_ALGOFAM_RSA` (0x04) is the RSA family
 identifier. No non-RSA algorithm family is defined in AUTOSAR R23-11.
...
- **NXP S32G HSE**: firmware-updateable HSM, but no non-RSA firmware released.
- **Renesas RH850**: SHE (Secure Hardware Extension) is hardware-only, no non-RSA.
...
operational in 2045. No automotive OEM has published a non-RSA migration roadmap.
