...
**PQC migration plan:** None — AVEVA/Schneider Electric has not published any PQC roadmap for PI System; PI Web API uses standard Windows IIS certificates with no PQC option
...
- AVEVA has not announced any PQC migration. PI System versioning is slow — many plants
...
- PI Connector certificates are issued by the PI Certificate Authority (a Windows CA
  component of PI System). No PQC key type is available in the PI CA.
