...
**PQC migration plan:** None — RPM's GPG signing uses GnuPG; GnuPG has experimental ML-DSA in development but it's not in stable releases; no Red Hat or Fedora announcement on PQC signing keys
...
- Older RHEL keys (RSA-2048, used for RHEL 6/7 packages still in use in long-tail
  ...
  is end-of-life.
- Any PQC migration would need to be coordinated across Red Hat, Fedora, CentOS, Rocky,
